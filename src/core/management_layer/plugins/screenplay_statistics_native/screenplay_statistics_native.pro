...
TARGET = screenplaystatisticsnativeplugin
...
HEADERS += \
    screenplay_statistics_native_manager.h \
    screenplay_statistics_native_view.h

SOURCES += \
    screenplay_statistics_native_manager.cpp \
    screenplay_statistics_native_view.cpp
